...
ADD https://repo.maven.apache.org/maven2/org/apache/directory/fortress/fortress-rest/2.0.6/fortress-rest-2.0.6.war /usr/local/tomcat/webapps/
ADD https://repo.maven.apache.org/maven2/org/apache/directory/fortress/fortress-realm-proxy/2.0.6/fortress-realm-proxy-2.0.6.jar /usr/local/tomcat/lib/
